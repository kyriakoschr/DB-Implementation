...
typedef struct IndexBlockUnit {
	int KeyValue;
	int Pointer;
} IndexBlockUnit;

typedef struct DataBlockUnit {
	void *value1;
	void *value2;
} DataBlockUnit;
...
extern OpenFile OpenFiles[MAXOPENFILES];
extern OpenScan OpenScans[MAXSCANS];
